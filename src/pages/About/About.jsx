    ...
    <div className="bg-gradient-to-br from-slate-900 via-slate-950 to-black py-8 md:py-16">
      <div className="max-w-6xl mx-auto flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-slate-800 p-6 rounded-2xl text-center shadow-lg hover:scale-105 transition">
        ...
        {/* Mission Section */}
        <div className="bg-slate-800 p-8 rounded-2xl shadow-lg text-center text-white">
