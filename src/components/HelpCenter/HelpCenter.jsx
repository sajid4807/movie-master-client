    ...
    <div className="px-4 md:px-0 py-8 md:py-16 bg-gradient-to-br from-slate-900 via-slate-950 to-black text-white">
      <div className="max-w-5xl mx-auto bg-slate-800 rounded-2xl p-8 shadow-lg">
        ...
        <p className="text-gray-300 mb-6">
          Welcome to{" "}
          <span className="font-semibold text-cyan-400">Movie Master</span> Help
          Center. Here you can find answers to common questions, guides, and
          tips for using our platform.
        </p>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-1">
              ...
              <li>
                How to update your profile picture, username, and personal info.
              </li>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-1">
              <li>
                How to report bugs, inappropriate content, or suspicious
                activity.
              </li>
        ...
        <p className="text-gray-400 text-sm mt-10 text-center">
          ...
          <span className="text-cyan-400 font-semibold">Movie Master</span>. All
          rights reserved.
        </p>
      </div>
    </div>
