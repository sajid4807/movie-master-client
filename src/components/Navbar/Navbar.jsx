      ...
      <div className="relative navbar px-4 md:px-20 py-4">
        ...
        <div className="navbar-start">
          ...
          <div className="dropdown lg:hidden">
            ...
            <ul
              tabIndex={-1}
              className={`menu menu-sm dropdown-content bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl z-[999] mt-3 w-64 p-3 shadow-2xl border border-cyan-500/20 backdrop-blur-xl ${
            ...
            <div className="flex gap-2 md:gap-5 items-center z-10">
              ...
              <div className="flex items-center">
                <div className="dropdown dropdown-end">
                  ...
                  <ul
                    tabIndex={-1}
                    className="menu menu-sm dropdown-content bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 w-52 md:w-60 rounded-2xl z-[99] mt-3 p-3 shadow-2xl border border-cyan-500/20 backdrop-blur-xl right-0"
                  >
                    <li>
  <p className="font-bold text-xl text-white uppercase">{user?.displayName || "User"}</p>
</li>
  ...
  <NavLink
    ...
    className={({ isActive }) =>
      `smooth-border-underline flex items-center gap-2 transition-colors
       ${isActive ? "bg-slate-700/50 text-cyan-400" : "hover:bg-slate-700/50"}`
    }
  >
