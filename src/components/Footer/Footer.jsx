  ...
  return (
    <footer className="bg-gradient-to-b from-slate-950 via-slate-900 to-black border-t border-cyan-500/20 pt-10 md:pt-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        {/* Main Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 justify-between gap-10 md:gap-12 pb-10">
          {/* Brand Section */}
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Your place for movies, anime & entertainment — smooth UI
              experience.
            </p>
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                className="p-2.5 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all cursor-pointer hover:scale-110"
              >
                <FaGithub className="text-gray-300 hover:text-white text-lg transition-colors" />
              </a>
              {/* LinkedIn */}
              <a
                ...
                className="p-2.5 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all cursor-pointer hover:scale-110"
              >
                <FaLinkedin className="text-gray-300 hover:text-blue-500 text-lg transition-colors" />
              </a>
              <a
              ...
              <a
                href="https://www.instagram.com/md_sajid_hossen_9156/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2.5 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all cursor-pointer hover:scale-110"
              >
          ...
          <div className="md:text-center">
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  to="help-center"
                  className="text-gray-400 text-sm hover:text-blue-300 transition-colors cursor-pointer"
                >
                  Help Center
                </Link>
              </li>
          ...
          <div className="md:text-center">
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  to="/term"
                  className="text-gray-400 text-sm hover:text-purple-300 transition-colors cursor-pointer"
                >
                  Terms & Conditions
                </Link>
              </li>
      ...
      <div className="border-t border-cyan-500/20 relative">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500">
          <p>
            ...
            <span className="text-cyan-400 font-semibold">Movie Master</span> —
            All Rights Reserved.
          </p>
